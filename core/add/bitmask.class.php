...
interface iBitMask{
	...
	public function add_element($mask_element);
	public function add_assoc($assoc_bits);
	public function assoc_get($all_values, $force);
	public function reverse_mask($mask);
}

class BitMask implements iBitMask {
	/**
	...
	* @access private
	*/
	private function _set_mask_array() {
